    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Attack()
        {
            if (_input.lightAttack)
            {
                ...
                _animator.SetBool(_animIDAttackTriggered, true);
                StartCoroutine(AttackWait());

            }
        }
        private System.Collections.IEnumerator AttackWait()
        {
            Debug.Log("Starting delayed action...");
            yield return new WaitForSeconds(1.4f); // Wait for 2 seconds
            _animator.SetBool(_animIDAttackTriggered, false);
            Debug.Log("Action completed after 2 seconds!");
        }
